        ...
        <section style="text-align: center; direction: ltr;">
            <form>
                <div class="es_form_group" style="margin: 10px;">
                    ...
                    <div>
                        <input type="text" class="form-control" id="code_prefix" aria-describedby="prefixHelp" placeholder="prefix" value="bulker" style="border-width: 2px; border-radius: 5px; direction: ltr; font-size: 16px; border-color: #0270bc;">
                    </div>
                    <div>
                ...
                <div class="form-group" style="margin: 10px;">
                    ...
                    <div>
                        <input type="number" class="form-control" id="bulker_num" value="1" style="border-width: 2px; border-radius: 5px; direction: ltr; font-size: 16px; border-color: #0270bc;">
                    </div>
                </div>
            </form>
            <hr>
            ...
            <hr>
            <button id="coupon_bulk_generate" data-id="<?= $coupon_id ?>" type="button" class="btn btn-primary" style="text-align: center; border-radius: 5px; font-size: 20px; background-color: #0270bc; color: #ffffff; padding: 10px;">Generate</button>
